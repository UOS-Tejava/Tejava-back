...
public class EmployeeController {
    ...
    public ResponseEntity<List<Order>> showOrders(@RequestBody UserIdDTO userIdDTO) {

        List<Order> orderList = employeeService.getOrderList(userIdDTO);
    ...
    public ResponseEntity<?> updateOrderStatus(@RequestBody UserIdDTO userIdDTO, @RequestBody ChangeOrderStatusDTO changeOrderStatusDTO) {

        employeeService.updateOrderStatus(userIdDTO, changeOrderStatusDTO);
    ...
    public ResponseEntity<List<StockItem>> showStockInfo(@RequestBody UserIdDTO userIdDTO) {

        List<StockItem> stockItemList = employeeService.showStockInfo(userIdDTO);
